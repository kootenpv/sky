...
def get_name(x, namedAttrs=['class', 'id']):
...
def traverser(parent, graph, pruning=True, namedAttrs=['class', 'id']):
    graph = []        
    for x in parent:
...
def soupTree(soups, returning=False, printing=True, pruning=True, namedAttrs=['class', 'id']):
    outps = []
    max_lens = 0
...
def lxml_get_name(x, namedAttrs=['class', 'id']):
    my_string = x.tag
...
def lxml_traverser(parent, graph, pruning=True, namedAttrs=['class', 'id']):
    graph = []        
    for x in parent:
...
def lxmlTree(lxmls, returning=False, printing=True, pruning=True, namedAttrs=['class', 'id']):
    outps = []
    max_lens = 0
